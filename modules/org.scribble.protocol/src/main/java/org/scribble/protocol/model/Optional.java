...
/**
 * This class represents the Optional construct.
 * 
 */
public class Optional extends Behaviour implements SinglePathBehaviour {
	...
	public void visit(Visitor visitor) {
		visitor.startOptional(this);
		
		if (getBlock() != null) {
			getBlock().visit(visitor);
		}
		
		visitor.endOptional(this);
	}
