...
public class ProtocolParserTest {
	...
	public void testSingleInteraction() {
		...
		ProtocolModel model=CTKUtil.getModel("SingleInteraction", logger);
	...
	public void testSingleInteractionRPC() {
		...
		ProtocolModel model=CTKUtil.getModel("SingleInteractionRPC", logger);
	...
	public void testSingleInteractionWithChannel() {
		...
		ProtocolModel model=CTKUtil.getModel("SingleInteractionWithChannel", logger);
	...
	public void testSingleInteractionWithChannel2() {
		...
		ProtocolModel model=CTKUtil.getModel("SingleInteractionWithChannel2", logger);
	...
	public void testRaise() {
		...
		ProtocolModel model=CTKUtil.getModel("Raise", logger);
	...
	public void testTryCatchInterrupt() {
		...
		ProtocolModel model=CTKUtil.getModel("TryCatchInterrupt", logger);
	...
	public void testChoice() {
		...
		ProtocolModel model=CTKUtil.getModel("Choice", logger);
	...
	public void testParallel() {
		...
		ProtocolModel model=CTKUtil.getModel("Parallel", logger);
	...
	public void testRepeat() {
		...
		ProtocolModel model=CTKUtil.getModel("Repeat", logger);
	...
	public void testRunSubProtocol() {
		...
		ProtocolModel model=CTKUtil.getModel("RunSubProtocol", logger);
	...
	public void testRunInlineProtocol() {
		...
		ProtocolModel model=CTKUtil.getModel("RunInlineProtocol", logger);
